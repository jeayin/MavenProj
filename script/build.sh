...
mvn deploy:deploy-file -DgroupId=comjeayapp -DartifactId=$1 -Dversion=1.0.$2 -DgeneratePom=false -DpomFile=pom.xml -Dpackage=jar -Drepository=nexus -Durl=http://192.168.25.132:8081/repository/maven-releases/ -Dfile=target/JavaProj-1.0.$2.jar
